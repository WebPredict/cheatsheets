...
| Shortest path, weighted graph (non-negative) | **Dijkstra** |
| All paths, any path, cycle detection | **DFS** |
| Dependencies / prerequisites / ordering | **Topological sort** |
| Connected components, dynamic merging | **Union-Find** |
| K-th largest/smallest, top-k, median of stream | **Heap** |
| Optimization with overlapping subproblems | **Dynamic programming** |
| Enumerate combinations / permutations / subsets | **Backtracking** |
...
| Range sums, frequency counting over ranges | **Prefix sums** |
| Single number, XOR tricks, subset masks | **Bit manipulation** |
